...
//////void FFV::setScalarGridData(REAL_TYPE* d, REAL_TYPE* data, int id, int jd, int kd)
//////{
//////  int ix = size[0];
//////  int jx = size[1];
//////  int kx = size[2];
...
//////void FFV::setVectorGridData(REAL_TYPE* d, REAL_TYPE* data, int id, int jd, int kd)
//////{
//////  int ix = size[0];
//////  int jx = size[1];
//////  int kx = size[2];
...
//////
//////// Vectorの格子点での値をセット（ガイドセルの値は計算対象にいれていない）
//////void FFV::setVectorComponentGridData(REAL_TYPE* d, REAL_TYPE* data, int id, int jd, int kd, int ivar)
//////{
//////  int ix = size[0];
//////  int jx = size[1];
//////  int kx = size[2];
...
//////
////////内部の格子点のデータを8で割る
//////void FFV::VolumeDataDivideBy8(REAL_TYPE* d, int id, int jd, int kd)
//////{
//////  int i,j,k,ip;
//////  for (k=1; k<kd-1; k++){
//////    for (j=1; j<jd-1; j++){
...
//////
////////面上の格子点のデータを4で割る
//////void FFV::FaceDataDivideBy4(REAL_TYPE* d, int id, int jd, int kd)
//////{
//////  int i,j,k,ip;
//////
//////  i=0;
...
//////
////////辺上の格子点のデータを2で割る
//////void FFV::LineDataDivideBy2(REAL_TYPE* d, int id, int jd, int kd)
//////{
//////  int i,j,k,ip;
//////
//////  i=0; j=0;
