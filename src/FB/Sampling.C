...
Vec3r InterpolationStgV::samplingVelocity(const REAL_TYPE* v)
{
  ...
  m_1 = _F_IDX_V3DEX(0, i+1, j  , k  , ix, jx, kx, gd);
  m_2 = _F_IDX_V3DEX(0, i  , j+1, k  , ix, jx, kx, gd);
  m_3 = _F_IDX_V3DEX(0, i+1, j+1, k  , ix, jx, kx, gd);
  m_4 = _F_IDX_V3DEX(0, i  , j  , k+1, ix, jx, kx, gd);
  m_5 = _F_IDX_V3DEX(0, i+1, j  , k+1, ix, jx, kx, gd);
  m_6 = _F_IDX_V3DEX(0, i  , j+1, k+1, ix, jx, kx, gd);
  m_7 = _F_IDX_V3DEX(0, i+1, j+1, k+1, ix, jx, kx, gd);
  r[0] = v[ m_0 ];
  r[1] = v[ m_1 ];
  r[2] = v[ m_2 ];
  r[3] = v[ m_3 ];
  ...
  m_1 = _F_IDX_V3DEX(1, i+1, j  , k  , ix, jx, kx, gd);
  m_2 = _F_IDX_V3DEX(1, i  , j+1, k  , ix, jx, kx, gd);
  m_3 = _F_IDX_V3DEX(1, i+1, j+1, k  , ix, jx, kx, gd);
  m_4 = _F_IDX_V3DEX(1, i  , j  , k+1, ix, jx, kx, gd);
  m_5 = _F_IDX_V3DEX(1, i+1, j  , k+1, ix, jx, kx, gd);
  m_6 = _F_IDX_V3DEX(1, i  , j+1, k+1, ix, jx, kx, gd);
  m_7 = _F_IDX_V3DEX(1, i+1, j+1, k+1, ix, jx, kx, gd);
  r[0] = v[ m_0 ];
  r[1] = v[ m_1 ];
  r[2] = v[ m_2 ];
  r[3] = v[ m_3 ];
  ...
  m_1 = _F_IDX_V3DEX(2, i+1, j  , k  , ix, jx, kx, gd);
  m_2 = _F_IDX_V3DEX(2, i  , j+1, k  , ix, jx, kx, gd);
  m_3 = _F_IDX_V3DEX(2, i+1, j+1, k  , ix, jx, kx, gd);
  m_4 = _F_IDX_V3DEX(2, i  , j  , k+1, ix, jx, kx, gd);
  m_5 = _F_IDX_V3DEX(2, i+1, j  , k+1, ix, jx, kx, gd);
  m_6 = _F_IDX_V3DEX(2, i  , j+1, k+1, ix, jx, kx, gd);
  m_7 = _F_IDX_V3DEX(2, i+1, j+1, k+1, ix, jx, kx, gd);
  r[0] = v[ m_0 ];
  r[1] = v[ m_1 ];
  r[2] = v[ m_2 ];
  r[3] = v[ m_3 ];
