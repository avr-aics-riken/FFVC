#ifndef _SKL_FB_PERFWATCH_H_
#define _SKL_FB_PERFWATCH_H_
...
//@file PerfWatch.h
//@brief FlowBase PerfWatch class Header
 ...
 * 計算性能「測定時計」クラス.
 */
class PerfWatch : public Parallel_Node {
public:
...
public:
  ...
  ///
  void setProperties(const string& label, bool typeCalc, bool exclusive) {
    m_label = label;
    m_typeCalc = typeCalc;
  ...
  ///   @return  単位変換後の数値
  ///
  static double flops(double fops, string &unit, bool mode);
