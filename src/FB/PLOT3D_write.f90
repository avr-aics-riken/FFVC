...
!  ***************************************************
!> @subroutine write_func_block_data(id, jd, kd, nvar, ifl)
!! @brief 
!! @param 
!! @param[out] 
!<
    ...
    write(ifl) id,jd,kd,nvar
    
    return
    end subroutine write_func_block_data

!  ***************************************************
!> @subroutine write_func_block_data_formatted(id, jd, kd, nvar, ifl)
!! @brief 
!! @param 
!! @param[out] 
!<
...
!<
    ...
    write(ifl) (((y(i,j,k),i=1,id),j=1,jd),k=1,kd)
    write(ifl) (((z(i,j,k),i=1,id),j=1,jd),k=1,kd)
...
!<
    ...
    write(ifl) (((y(i,j,k),i=1,id),j=1,jd),k=1,kd)
    write(ifl) (((z(i,j,k),i=1,id),j=1,jd),k=1,kd)
    write(ifl) (((iblank(i,j,k),i=1,id),j=1,jd),k=1,kd)
