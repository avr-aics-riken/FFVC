...
parameter ( facing_t = 8 ) ! FBDefine.h FACING_T
parameter ( facing_b = 7 ) ! FBDefine.h FACING_B
parameter ( facing_n = 6 ) ! FBDefine.h FACING_N
parameter ( facing_s = 5 ) ! FBDefine.h FACING_S
parameter ( facing_e = 4 ) ! FBDefine.h FACING_E
parameter ( facing_w = 3 ) ! FBDefine.h FACING_W
parameter ( vld_cnvg = 2 ) ! FBDefine.h VLD_CNVG
parameter ( vbc_uwd  = 1 ) ! FBDefine.h VBC_UWD

! 速度，温度1のビットフラグ
parameter ( bc_face_T = 25 ) ! FBDefine.h BC_FACE_T
parameter ( bc_face_B = 20 ) ! FBDefine.h BC_FACE_B
parameter ( bc_face_N = 15 ) ! FBDefine.h BC_FACE_N
parameter ( bc_face_S = 10 ) ! FBDefine.h BC_FACE_S
parameter ( bc_face_E = 5  ) ! FBDefine.h BC_FACE_E
parameter ( bc_face_W = 0  ) ! FBDefine.h BC_FACE_W

! 温度2のビットフラグ
parameter ( adbtc_T = 29) ! FBDefine.h ADIABATIC_T
parameter ( adbtc_B = 28) ! FBDefine.h ADIABATIC_B
parameter ( adbtc_N = 27) ! FBDefine.h ADIABATIC_N
parameter ( adbtc_S = 26) ! FBDefine.h ADIABATIC_S
parameter ( adbtc_E = 25) ! FBDefine.h ADIABATIC_E
parameter ( adbtc_W = 24) ! FBDefine.h ADIABATIC_W

parameter ( gma_T = 23) ! FBDefine.h GMA_T
parameter ( gma_B = 22) ! FBDefine.h GMA_B
parameter ( gma_N = 21) ! FBDefine.h GMA_N
parameter ( gma_S = 20) ! FBDefine.h GMA_S
parameter ( gma_E = 19) ! FBDefine.h GMA_E
parameter ( gma_W = 18) ! FBDefine.h GMA_W

parameter ( h_diag = 15 ) ! FBDefine.h H_DIAG
...
! 内部コンポーネント番号
parameter ( cmp_typ_outflow = 8  ) ! FBDefine.h OUTFLOW
parameter ( cmp_typ_vspec   = 7  ) ! FBDefine.h SPEC_VEL
parameter ( cmp_typ_hex     = 12 ) ! FBDefine.h HEX

! 外部境界条件番号
parameter ( obc_mask     = 31) ! FBDefine.h OBC_MASK 内外部境界条件の識別子
parameter ( obc_outflow  = 3 ) ! FBDefine.h OBC_OUTFLOW 
parameter ( obc_periodic = 5 ) ! FBDefine.h OBC_PERIODIC
