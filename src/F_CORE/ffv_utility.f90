...
!$OMP PARALLEL &
!$OMP FIRSTPRIVATE(ix, jx, kx, amn, bmn)
!$OMP DO SCHEDULE(static)
  ...
  do i = 1, ix
    ...
    C(i, j, k, 1) = amn(1, 1)*bmn(1, 1) + amn(1, 2)*bmn(2, 1) + amn(1, 3)*bmn(3, 1)
    C(i, j, k, 2) = amn(1, 1)*bmn(1, 2) + amn(1, 2)*bmn(2, 2) + amn(1, 3)*bmn(3, 2)
    C(i, j, k, 3) = amn(1, 1)*bmn(1, 3) + amn(1, 2)*bmn(2, 3) + amn(1, 3)*bmn(3, 3)
    C(i, j, k, 4) = amn(2, 1)*bmn(1, 1) + amn(2, 2)*bmn(2, 1) + amn(2, 3)*bmn(3, 1)
    C(i, j, k, 5) = amn(2, 1)*bmn(1, 2) + amn(2, 2)*bmn(2, 2) + amn(2, 3)*bmn(3, 2)
    C(i, j, k, 6) = amn(2, 1)*bmn(1, 3) + amn(2, 2)*bmn(2, 3) + amn(2, 3)*bmn(3, 3)
    C(i, j, k, 7) = amn(3, 1)*bmn(1, 1) + amn(3, 2)*bmn(2, 1) + amn(3, 3)*bmn(3, 1)
    C(i, j, k, 8) = amn(3, 1)*bmn(1, 2) + amn(3, 2)*bmn(2, 2) + amn(3, 3)*bmn(3, 2)
    C(i, j, k, 9) = amn(3, 1)*bmn(1, 3) + amn(3, 2)*bmn(2, 3) + amn(3, 3)*bmn(3, 3)
  end do
  end do
  end do
!$OMP END DO
