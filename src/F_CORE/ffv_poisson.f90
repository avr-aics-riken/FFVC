...
call cpm_Isend(cf_x(1,1), cf_sz(1), CPM_REAL, nID(1), 0, key(1,1), ierr)
endif
endif
...
call cpm_Irecv(cf_x(1,3), cf_sz(1), CPM_REAL, nID(2), 0, key(1,2), ierr)
end if
endif
...
call cpm_Isend(cf_x(1,2), cf_sz(1), CPM_REAL, nID(2), 0, key(2,1), ierr)
end if
endif
...
call cpm_Irecv(cf_x(1,4), cf_sz(1), CPM_REAL, nID(1), 0, key(2,2), ierr)
endif
endif
...
call cpm_Isend(cf_y(1,1), cf_sz(2), CPM_REAL, nID(3), 0, key(3,1), ierr)
endif
endif
...
call cpm_Irecv(cf_y(1,3), cf_sz(2), CPM_REAL, nID(4), 0, key(3,2), ierr)
endif
endif
...
call cpm_Isend(cf_y(1,2), cf_sz(2), CPM_REAL, nID(4), 0, key(4,1), ierr)
endif
endif
...
call cpm_Irecv(cf_y(1,4), cf_sz(2), CPM_REAL, nID(3), 0, key(4,2), ierr)
endif
endif
...
call cpm_Isend(cf_z(1,1), cf_sz(3), CPM_REAL, nID(5), 0, key(5,1), ierr)
endif
endif
...
call cpm_Irecv(cf_z(1,3), cf_sz(3), CPM_REAL, nID(6), 0, key(5,2), ierr)
endif
endif
...
call cpm_Isend(cf_z(1,2), cf_sz(3), CPM_REAL, nID(6), 0, key(6,1), ierr)
endif
endif
...
call cpm_Irecv(cf_z(1,4), cf_sz(3), CPM_REAL, nID(5), 0, key(6,2), ierr)
endif
endif
...
call cpm_Wait(key(1,1), ierr)
endif
if( key(2,1).ge.0) then
call cpm_Wait(key(2,1), ierr)
endif
if( key(3,1).ge.0) then
call cpm_Wait(key(3,1), ierr)
endif
if( key(4,1).ge.0) then
call cpm_Wait(key(4,1), ierr)
endif
if( key(5,1).ge.0) then
call cpm_Wait(key(5,1), ierr)
endif
if( key(6,1).ge.0) then
call cpm_Wait(key(6,1), ierr)
endif
