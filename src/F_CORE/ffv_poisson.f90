...
!$OMP END DO
    ...
    do i_inner = 1, n_inner
      call psor_m1 (para_key, xt, sz, g, omg, e, res, rest, bnd, commmode, do_time, commtime, dtype)
      iparam(2) = iparam(2) + 1
    enddo
...
!$OMP END DO
      ...
      call psor (para_key, p, sz, g, omg, res, wrk, bnd, commmode, do_time, commtime, dtype)
      iparam(2) = iparam(2) + 1
