...
/**
 @fn void IP_RSP::setup(int* mid, Control* R, REAL_TYPE* G_org, const int Nmax, IDtable* itbl)
 ...
 @param itbl IDtable
 */
void IP_RSP::setup(int* mid, Control* R, REAL_TYPE* G_org, const int Nmax, IDtable* itbl)
{
  int i,j,k;
  unsigned m;
