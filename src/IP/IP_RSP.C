...
/**
 @fn void IP_RSP::setup(int* mid, Control* R, REAL_TYPE* G_org, const int Nmax, MediumList* mtl)
 ...
 @param mtl
 */
void IP_RSP::setup(int* mid, Control* R, REAL_TYPE* G_org, const int Nmax, MediumList* mtl)
{
  int i,j,k;
  unsigned m;
