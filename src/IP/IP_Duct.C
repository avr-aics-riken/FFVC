...
/**
 @fn void IP_Duct::setup(int* mid, Control* R, REAL_TYPE* G_org, const int Nmax, IDtable* itbl)
 ...
 @param itbl IDtable
 */
void IP_Duct::setup(int* mid, Control* R, REAL_TYPE* G_org, const int Nmax, IDtable* itbl)
{
  int i,j,k, gd;
  int mid_fluid=1;        /// 流体
  int mid_solid=2;        /// 固体
